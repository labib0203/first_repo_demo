...
BEGIN
    -- This procedure returns the cumulative daily net earnings between a start and end date
    -- Net earning = Sum(Paid Invoices on the day) - Sum(Pharmacy Restock Expenses on the day)
    ...
    FROM (
        -- Generate dates using a recursive CTE (MySQL 8.0+)
